...
public class AutoSuggestor {
    ...
    public void hideSuggestionWindow() {
    ...
    private void showPopUpWindow() {
        ...
        autoSuggestionPopUpWindow.setLocation(x, y + textComp.getHeight());
        autoSuggestionPopUpWindow.setMinimumSize(new Dimension(textComp.getWidth(), 30));
    ...
    boolean wordTyped(String typedWord) {
        ...
        } catch(Exception e) { // This is because the writer of this code left a bug where if two words contain the same beginning the loop will search to a non-existing char causing an error we do not want
